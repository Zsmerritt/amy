...
const struct FmAlgorithm algorithms[41] = {
    // 6     5     4     3     2      1   
    ...
    { { 0xC1, 0x05, 0x02, 0x25, 0x11, 0x14 } }, // 33
    { { 0x41, 0x91, 0x11, 0x11, 0x11, 0x14 } }, // 34
    { { 0xC1, 0x05, 0x14, 0x01, 0x05, 0x14 } }, // 35
    { { 0xC1, 0x05, 0x05, 0x05, 0x14, 0x14 } }, // 36
    { { 0xC1, 0x11, 0x02, 0x25, 0x14, 0x14 } }, // 37
    { { 0xC1, 0x14, 0x01, 0x05, 0x14, 0x14 } }, // 38
    { { 0xC1, 0x05, 0x14, 0x14, 0x14, 0x14 } }, // 39
    { { 0xC1, 0x11, 0x14, 0x14, 0x14, 0x14 } }, // 40
};
// End of MSFA stuff
